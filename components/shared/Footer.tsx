...
const Footer = () => {
  ...
  return (
    <div
      className='w-full h-full  bg-cover bg-right-bottom bg-no-repeat pt-10 relative '
      style={{
    ...
    >
      <div className='flex flex-col md:flex-row w-full mx-auto gap-14 py-1 items-center'>
        <div className='w-4/5 md:w-2/3 mx-auto' >
          <Image src="/images/footer_title1.png" alt="title" width={300} height={100} className=' mx-auto'/>
          ...
          <div className='md:w-full mx-auto'>
            <form onSubmit={handleSubmit(onSubmit)} className="w-full mx-auto pt-5  rel" data-aos="fade-up" data-aos-duration="1500" >
              ...
              <div className='flex flex-col w-full mx-auto gap-4 my-3 md:mt-8'>
                <button 
                  className={`px-2 py-2 font-bold w-full text-md tracking-wide text-[#fff] ${submitDisabled ? 'bg-gray-400' : 'bg-[#C3181F]'}`}
                  type='submit' 
            ...
            <div className='my-20'>
              <Image src="/images/footer_title.png" alt="title" width={300} height={100} className=' mx-auto'/>
              <Image src="/images/footer_subtitle.png" alt="title" width={100} height={100} className='mt-10 mx-auto'/>
            </div>
          </div>
        </div>
      </div>
