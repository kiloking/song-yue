  ...
  return (
    <div className='w-full pt-10 md:pt-24 md:pb-20 pb-8 relative'>
      ...
      <div className='w-4/12 mx-auto relative'>
        ...
        <div className=' absolute bottom-4 md:bottom-10 -right-[30px] md:-right-32  w-[10%]' data-aos="fade"><img src="/images/release/bird02.png" alt="" className='w-full' /></div>
        
      </div>

      <div className='w-full md:w-3/4 mx-auto mt-10'>
        <img src="/images/release/section02_map.png" alt="" className='w-full' data-aos="zoom-out" />
      </div>
      ...
      <div className='my-14 flex items-center gap-10 w-full md:w-3/4 mx-auto'>
        ...
        <div className='md:p-10'><img src="/images/release/section02_text.png" alt="" className='w-full' data-aos="fade"/></div>
      </div>

      <div className=' absolute bottom-0 right-0 w-[45%]'><img src="/images/release/section02_bottom.png" alt="" className='w-full' /></div>
    </div>
  )
}
